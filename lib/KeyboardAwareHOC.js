...
function KeyboardAwareHOC(
  ...
  return class
    ...
    static propTypes = {
      ...
      customExtraHeight: PropTypes.number,
    ...
    static defaultProps = {
      ...
      customExtraHeight: hocOptions.customExtraHeight,
                ...
                (x: number, y: number, width: number, height: number) => {
                  ...
                  if (Platform.OS === 'ios') {
                    ...
                    if (textInputBottomPosition > keyboardPosition) {
                      ...
                      /* modified by kevin at 2019-08-26 begin */
                      ...
                      /* modified by kevin at 2019-08-26 end */
                    } else if (
                      textInputBottomPosition >
                      keyboardPosition - totalExtraHeight
                    ) {
    ...
    _scrollToFocusedInputWithNodeHandle = (
      ...
      if (this.props.customExtraHeight) {
        extraHeight += this.props.customExtraHeight
      }
